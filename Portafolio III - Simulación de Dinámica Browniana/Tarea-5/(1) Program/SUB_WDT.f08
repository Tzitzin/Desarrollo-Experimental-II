...
!                           X   = 
!   ====================================================================================|
SUBROUTINE WDT(N, NN2, BOXL, DENS, CXR, CYR, CZR, KI2, DT, NFREC2)
    IMPLICIT NONE
        INTEGER                                         :: I, J, K, NTMAX
        REAL(KIND=8), INTENT(IN)                        :: BOXL, DENS, DT
        INTEGER, INTENT(IN)                             :: N, NFREC2, KI2, NN2
        REAL(KIND=8), DIMENSION(N,NN2), INTENT(IN)      :: CXR, CYR, CZR
        REAL(KIND=8)                                    :: TIM, WTX, WTY, WTZ, WT, TIME, DIF


!   APERTURA DE ARCHIVOS ----------------------------------------------------------------
    OPEN (16,   FILE = '07WDT.dat',   STATUS = 'unknown')
