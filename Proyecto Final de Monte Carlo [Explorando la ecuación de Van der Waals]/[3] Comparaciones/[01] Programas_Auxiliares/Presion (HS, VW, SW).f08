...
!   Apertura de archivos --------------------------------------------   
    OPEN (10, FILE = '07AS.dat',                STATUS = 'old')         ![04]
    OPEN (12, FILE = '08PSW_UHS.dat',           STATUS = 'unknown')     ![05]
    OPEN (13, FILE = '09GDRSW_CONTACTOS.dat',   STATUS = 'old')         ![06]
    OPEN (14, FILE = '10PSW.dat',               STATUS = 'unknown')     ![07]
!   -----------------------------------------------------------------
...
!   Cálculo de la presión usando aproximación, ecuación (3.15)        
        READ(10,*) n(I), asa(I), asd(I), test(I), PHS(I)
